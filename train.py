...
from VOC2012 import VOCSegmentation
...
def get_dataset():
    ...
    train_dst = VOCSegmentation(root='./datasets/data', year='2012',
                                    image_set='train', divide_data=0 ,transform=train_transform)


    return train_dst

network = DeepLabV3(model_id, project_dir="./")
...
if num_train % batch_size == 1 :  # Prevent only one sample in the batch
    droplast = True
else:
    droplast = False
